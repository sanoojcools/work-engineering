# Colleague walk — Offer Desk (12 minutes)

Branch: `idea/v9`. One click setup. No terminal after the stack is up.
...
| 4 | Playback | Three columns | We do not vote them into one story. |
| 5 | Spreadsheet | 95 hrs claim, no Zwayam events | Declared write-up. Not a system log. |
| 6 | Save talk-only | Persist denied | A finished conversation is not a company work list. |
| 7 | How we cut it | One record: unchecked → accepted or blocked | Cut on owner × object × proof. |
...
- That 61.8 was measured on this desk this week.
...
The deny rule is already correct. A 500 after deny is the post-commit RLS refresh. Rebuild the backend image from this branch and retry the same button. Do not rewrite the gate.
