...
def main() -> int:
    ...
    parser.add_argument("--seed-runs", action="store_true", dest="seed_runs", help="Seed five passed verification runs")
    ...
    if not path.exists():
        ...
        if csv_fallback.exists():
            ...
            print(f"  python scripts/bulk_ingest.py --init-template --file {args.file}")
            return 1
